...
<title>Manager Order - Breart Book Store</title>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-warning shadow-warning border-radius-lg pt-4 pb-3 text-center">
                <h5><a class="text-white text-capitalize ps-3" href="#">Management Orders</a></h5>   
              </div>
            </div> <br>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">
                          ...
                          <i class="fa fa-pencil-square-o" aria-hidden="true">&nbsp;Details</i> |
                        </a>&nbsp;
