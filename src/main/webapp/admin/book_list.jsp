...
<title>Manager Books - Breart Book Store</title>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-warning shadow-warning border-radius-lg pt-4 pb-3 text-center">
                <h5><a class="text-white text-capitalize ps-3" href="new_book">Add new book</a></h5>   
              </div>
            </div> <br>
                    ...
                    <tr>
                      <td>
                      	<div class="d-flex flex-column justify-content-center">
                        	<p class="text-xs font-weight-bold mb-0">${book.bookId }</p>
                        </div>
                      </td>    
                      <td>
                      	<div class="d-flex flex-column justify-content-center">
                        	<img src="data:image/jpg;base64,${book.base64Image }" width="80">
                        </div>
                      </td>
                      <td>
                      	<div class="d-flex flex-column justify-content-center">
                      ...
                      <td>
                      	<div class="d-flex flex-column justify-content-center">
                      		<p class="text-xs font-weight-bold mb-0">${book.price }</p>  
                      	</div>
                      </td>
                      ...
                      <td class="align-middle">
                       <a href="new_book" class="text-secondary font-weight-bold text-xs">
                        ...
                        <a href="javascript:void(0);" class="text-secondary font-weight-bold text-xs">
                          <i class="fa fa-trash-o deleteLink" id="${book.bookId}" aria-hidden="true" style="color: red;">&nbsp;Delete</i>
                        </a>
                      </td>
                    </tr>
