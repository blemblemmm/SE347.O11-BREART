                            ...
                            <div class="login_part_form_iner">
                                ...
                                <form class="row contact_form" id="reviewForm" action="submit_review" method="post">
                                    <div class="col-md-12 form-group p_star">
                                     ...
                                     <div class="col-md-12 form-group p_star">
                                        <input type="text" class="form-control" name="headline" readonly="readonly" value="${review.headline}"/>
                                    </div>
                                     <div class="col-md-12 form-group p_star">
                                        <textarea name="comment" cols="50" rows="5" readonly="readonly" >${review.comment}</textarea>
                                    </div>
